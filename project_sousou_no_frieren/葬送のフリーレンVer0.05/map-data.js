...
const mapDatabase = {
    "northernForest": {
        ...
        chests: {
            // "y-x": { content: { type: "item" or "spell", name: "Item/Spell Name" }, opened: false }
            "6-1": { content: { type: "item", name: "薬草", quantity: 5 }, opened: false }
        }
    },
    "goblinCave": {
        name: "ゴブリンの洞窟",
        ...
        chests: {
            "1-12": { content: { type: "item", name: "魔石", quantity: 3 }, opened: false },
            "12-9": { content: { type: "spell", name: "火の魔法" }, opened: false }
        }
    },
    "snowyPlains": {
        name: "雪深き辺境",
        ...
        chests: {
            "5-4": { content: { type: "item", name: "金貨", quantity: 100 }, opened: false }
        }
    },
    "iceCave": {
        name: "氷結洞窟",
        ...
        chests: {
            "3-7": { content: { type: "spell", name: "氷の矢" }, opened: false }
        }
    }
};
