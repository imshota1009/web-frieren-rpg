document.addEventListener('DOMContentLoaded', () => {
    ...
    //  BGM Control
    // ==================================================================
    const allBgms = [titleBgm, mapBgm, battleBgm];
    ...
    const showScreen = (screenId) => {
        ...
        if (screenId === 'main-game-screen') {
            ...
            playBgm('battle-bgm');
        } else if (screenId.includes('screen')) { // splash, creation, menu screens
            playBgm('title-bgm');
        }
    ...
    // Initial user interaction to allow audio playback
    ...
    function updateTownScreen() {
        ...
        // Show/hide facilities based on map data
